...
export async function POST(req){
    ...
    const PROMPT = "Generate a study material for "+topic+" for " +courseType+" and level of difficulty should be "+difficultyLevel+" with summart of course, Include course_title, difficulty, summary, and chapters (array) with chapter_title, chapter_summary, and topics (list). Provide the result as structured JSON. "
